    ...
    <div class="card">
        <div class="row no-gutters">
            <div class="col-md-6 d-flex justify-content-center align-items-center p-2">
                ...
                <img src="{{url("$emp->imageSSN")}}" class="img-fluid" style="max-height: 150px;" alt="Image 1">
            </div>
            <div class="col-md-6 d-flex justify-content-center align-items-center p-2">
                ...
                <img src="{{url("$emp->livePhoto")}}" class="img-fluid" style="max-height: 150px;" alt="Image 1">
            </div>
        </div>
        <div class="card-body">
